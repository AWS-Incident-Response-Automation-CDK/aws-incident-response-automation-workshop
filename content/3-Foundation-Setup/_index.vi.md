...
- [Thiết lập Amazon S3 Bucket](3.1-set-up-s3-buckets/)
- [Cấu hình S3 Bucket Policy cho Primary Log Bucket](3.2-set-up-s3-buckets-policies/)
- [Tạo IAM Roles và Policies](3.3-create-iam-roles-and-policies/)