...
- [Set up Amazon S3 Bucket](3.1-set-up-s3-buckets/)
- [Configure S3 Bucket Policy for Primary Log Bucket](3.2-set-up-s3-buckets-policies/)
- [Create IAM Roles and Policies](3.3-create-iam-roles-and-policies/)