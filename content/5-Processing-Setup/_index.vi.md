...
- [Tạo Kinesis Data Firehose Delivery Streams](5.1-create-kinesis-data-firehose/)
- [Tạo AWS Glue Database và Tables](5.2-create-aws-glue-database-and-tables/)
- [Tạo Lambda Functions - Xử lý ETL](5.3-create-lambda-function-etl-processing/)
