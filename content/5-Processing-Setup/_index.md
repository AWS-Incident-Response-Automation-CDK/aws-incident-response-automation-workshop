...
- [Create Kinesis Data Firehose Delivery Streams](5.1-create-kinesis-data-firehose/)
- [Create AWS Glue Database and Tables](5.2-create-aws-glue-database-and-tables/)
- [Create Lambda Functions - ETL Processing](5.3-create-lambda-function-etl-processing/)
